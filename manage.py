...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            from donkeycar.parts.camera import Webcam
            cam = Webcam(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, iCam=1)
        elif cfg.CAMERA_TYPE == "CVCAM":
            from donkeycar.parts.cv import CvCam
    ...
    class DriveMode:
        def run(self, mode, 
            ...
            if mode == 'user': 
                ...
                return pilot_angle * cfg.AI_STEERING_MULT, pilot_throttle * cfg.AI_THROTTLE_MULT
    ...
    elif cfg.DRIVE_TRAIN_TYPE == "MOBILELAB":
        from donkeycar.parts.actuator import PCA9685, PWMSteering
        from my_actuator import PWMThrottle
